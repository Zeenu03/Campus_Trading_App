          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="card space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div><span className="text-gray-500">Posted:</span> <span className="font-medium">{formatDateUTC(wishRequest.created_date)}</span></div>
                <div><span className="text-gray-500">Needed by:</span> <span className="font-medium">{wishRequest.needed_by_date ? formatDateUTC(wishRequest.needed_by_date) : 'Not specified'}</span></div>
              </div>

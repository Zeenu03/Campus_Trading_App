...
CREATE TABLE Member (
    ...
    CONSTRAINT FK_Member_User FOREIGN KEY (user_id)
        REFERENCES sys_user(user_id) ON UPDATE CASCADE,
...
CREATE TABLE Listing (
    ...
    CONSTRAINT FK_Listing_WishRequest FOREIGN KEY (WishRequestID)
        REFERENCES WishRequest(WishRequestID) ON DELETE SET NULL,
...
CREATE TABLE Offer (
    ...
    CONSTRAINT FK_Offer_Listing FOREIGN KEY (ListingID)
        REFERENCES Listing(ListingID) ON UPDATE CASCADE,
...
CREATE TABLE `Transaction` (
    ...
    CONSTRAINT CHK_Transaction_Status CHECK (Status IN ('Scheduled','Completed','Cancelled')),
...
CREATE TABLE Watchlist (
    ...
    CONSTRAINT FK_Watchlist_Listing FOREIGN KEY (ListingID)
        REFERENCES Listing(ListingID) ON DELETE CASCADE,
...
CREATE TABLE Report (
    ...
    CONSTRAINT CHK_Report_Status CHECK (
        Status IN ('Submitted','UnderReview','Resolved','Dismissed')
    ),
    CONSTRAINT CHK_Report_Target CHECK (
        ReportedMemberID IS NOT NULL OR ReportedListingID IS NOT NULL
    )
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE Notification (
    ...
    CONSTRAINT FK_Notif_Recipient FOREIGN KEY (RecipientID)
        REFERENCES Member(MemberID) ON DELETE CASCADE,
    CONSTRAINT FK_Notif_Listing FOREIGN KEY (RelatedListingID)
        REFERENCES Listing(ListingID),
    CONSTRAINT FK_Notif_Offer FOREIGN KEY (RelatedOfferID)
        REFERENCES Offer(OfferID),
    CONSTRAINT FK_Notif_Transaction FOREIGN KEY (RelatedTransactionID)
...
CREATE TABLE MessageThread (
    ...
    CreatedDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    IsActive    BOOLEAN  NOT NULL DEFAULT TRUE,
    CONSTRAINT FK_Thread_Listing FOREIGN KEY (ListingID)
        REFERENCES Listing(ListingID),
    CONSTRAINT FK_Thread_Buyer FOREIGN KEY (BuyerID)
        REFERENCES Member(MemberID),
    CONSTRAINT FK_Thread_Offer FOREIGN KEY (OfferID)
        REFERENCES Offer(OfferID),
...
CREATE TABLE Message (
    ...
    CONSTRAINT FK_Message_Thread FOREIGN KEY (ThreadID)
        REFERENCES MessageThread(ThreadID) ON DELETE CASCADE,
